...
public class BaseClass {
    ...
    public void loadConfig() {
        try {
            ...
            FileInputStream ip = new FileInputStream( getProperty("user.dir") + "\\Configuration\\Config.properties");
            prop.load(ip);
    ...
    public static void launchApp() {
        ...
        ActionClass.implicitlyWait(20);
        ActionClass.pageLoadTimeOut(40);
